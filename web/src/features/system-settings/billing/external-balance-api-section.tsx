...
export function ExternalBalanceApiSection(props: Props) {
  ...
  const hasAnyKey = useMemo(
    ...
    [
      currentValues.ExternalBalanceApiKey,
      currentValues.ExternalBalanceApiKeyNext,
    ]
  )
  ...
  return (
    ...
    >
      ...
      <div className='grid gap-1.5'>
        ...
        <p className='text-muted-foreground text-xs'>
          {t(
            'Comma-separated IPs or CIDR ranges. Leave empty for no restriction.'
          )}
        </p>
      </div>
      ...
      <div className='text-muted-foreground text-xs'>
        {hasAnyKey
          ? t(
              'One or both keys are configured. Rotate by placing the next key here first.'
            )
