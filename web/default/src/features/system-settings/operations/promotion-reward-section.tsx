...
export function PromotionRewardSection({
  ...
  const [banner, setBanner] = useState<PromotionRewardBannerConfig>(initialBanner)
            ...
            <div className='grid gap-2'>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setBanner((prev) => ({
                    ...prev,
                    content_format: value as PromotionRewardBannerConfig['content_format'],
                  }))
                }
              >
            ...
            <div className='grid gap-2'>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setBanner((prev) => ({
                    ...prev,
                    image_position: value as PromotionRewardBannerConfig['image_position'],
                  }))
                }
              >
                <SelectTrigger className='w-full'>
