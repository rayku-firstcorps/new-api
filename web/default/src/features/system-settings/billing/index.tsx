...
const defaultBillingSettings: BillingSettings = {
  ...
  QuotaForInvitee: 0,
  AffCommissionRate: 0,
  AffCommissionDurationDays: 0,
  AffCommissionMaxPerTopup: 0,
  AffFirstTopupMinAmount: 0,
  TopUpLink: '',
  ...
  ExternalBalanceApiEnabled: false,
  ExternalBalanceApiKey: '',
  ExternalBalanceApiKeyNext: '',
  ExternalBalanceApiAllowQuery: true,
  ExternalBalanceApiAllowDeduct: false,
  ExternalBalanceApiMaxDeductQuota: 0,
  ...
  AirwallexSandbox: false,
  AirwallexCurrency: 'USD',
  AirwallexUnitPrice: 1,
  AirwallexMinTopUp: 1,
  PayssionEnabled: false,
  PayssionApiKey: '',
  PayssionWebhookSecret: '',
  PayssionCurrency: 'USD',
  PayssionUnitPrice: 1,
  PayssionMinTopUp: 1,
