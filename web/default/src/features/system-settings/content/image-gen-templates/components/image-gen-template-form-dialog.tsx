...
export function ImageGenTemplateFormDialog({ open, onOpenChange, template }: Props) {
  const { t } = useTranslation()
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-2xl max-h-[90vh] overflow-y-auto'>
        <DialogHeader>
          <DialogTitle>
            {isEditing ? t('Edit Image Gen Template') : t('Add Image Gen Template')}
          </DialogTitle>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='flex flex-row items-center gap-2 space-y-0'>
                    <FormLabel className='text-muted-foreground text-sm'>{t('Sort')}</FormLabel>
                    <FormControl>
                      <Input
                        type='number'
                        className='w-20'
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>{t('One URL per line (up to 4 images)')}</FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('Portrait, Landscape, Abstract')} {...field} />
                  </FormControl>
