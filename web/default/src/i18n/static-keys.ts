...
export const STATIC_I18N_KEYS = [
  ...
  'Enable This Link',
  'Add Community Link',
  'Please enter a valid community link',
  'Community link is required for enabled entries',
  'Community link URL must be unique',
  'Official communities saved successfully',
  'Failed to save official communities',
