...
- When reading project text files, explicitly use UTF-8 encoding (for example, `Get-Content -Encoding utf8` in PowerShell) to preserve Chinese and other non-ASCII text.
